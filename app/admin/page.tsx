...
import { Phone, Mail, Clock, User, Filter } from 'lucide-react';
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl border border-gray-200 p-8 max-w-sm w-full">
          ...
          <p className="text-sm text-gray-500 mb-6">Enter your admin key to view leads</p>
          <input
            type="password"
            value={key}
    ...
    <div className="min-h-screen bg-gray-50 p-4 lg:p-8">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Booking Leads</h1>
            <p className="text-sm text-gray-500">{bookings.length} total leads</p>
          </div>
          <button onClick={fetchBookings} className="px-4 py-2 bg-gray-900 text-white rounded-lg text-sm font-medium hover:bg-gray-800">
            Refresh
          </button>
        </div>
                ...
                {filtered.length === 0 ? (
                  ...
                  filtered.map((b) => (
                    <tr key={b._id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-3 text-gray-600">{b.preferredTime || '-'}</td>
